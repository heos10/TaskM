...
<body onload="loadTaskForUser(false)">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-navbar-main">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="about-us.html"><i class="fa fa-user"></i>&nbsp; Pending tasks</a></li>
            <li><a href="completedTasks.jsp"><i class="fa fa-coffee"></i>&nbsp; Completed Tasks</a></li>
...
<div class="container CustomProperty">
    ...
    font-weight: bolder;">
        ...
        <!-- button download cv -->
        <p>
			<button onclick="addAction()" type="button" class="fa fa-files-o btn btn-lg btn-primary">Add tasks</button>
        </p>
		...
		<div class="table-responsive">        
              <table id="mytable" class="table table-bordred table-striped">
                   ...
                   <tr><th>Click to Mark As Completed</th>
                   <th>Task Title</th>
                    <th>Task Message</th>
                     <th>Date</th>
                     <th>Priority</th>
